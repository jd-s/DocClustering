...
logging.debug (" ========")
logging.info ("  Starting PS-Clustering Algorithm strategy_independent_set on "+filename)
logging.info (" ========")
...
d = nx.coloring.greedy_color(G, strategy=nx.coloring.strategy_independent_set)  #strategy_independent_set
